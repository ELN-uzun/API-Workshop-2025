...
API_HOST_URL = 'https://host-url/api/v2'  # or any other endpoint you need
API_KEY = 'your api key'  # Replace with your API key
PERIOD_IN_DAYS = 300  # Or any other period you prefer
user_id = 2 # your own user ID
save_dir = "C:\\Users\\...\\API_Schulung\\files" # the location where to save it; \\-slash for windows users and /-slash for linux users
